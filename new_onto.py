        ...
        for i, row in enumerate(data_rows):
            ...
            try:
                ...
                if plant_ind and prop_plantId:
                    ...
                    if getattr(plant_ind, "plantId", None) != plant_id:
                ...
                if area_ind:
                    ...
                    if prop_areaId:
                         # Functional Property: Use getattr/setattr
                        if getattr(area_ind, "areaId", None) != area_id:
                ...
                if pcell_ind:
                    ...
                    if prop_processCellId:
                         # Functional Property: Use getattr/setattr
                        if getattr(pcell_ind, "processCellId", None) != pcell_id:
                ...
                if line_ind:
                    ...
                    if prop_lineId:
                         # Functional Property: Use getattr/setattr
                        if getattr(line_ind, "lineId", None) != line_id:
                ...
                if eq_type == 'Line' and line_ind:
                    ...
                    if equipment_ind:
                        ...
                        if prop_equipmentId:
                             # Functional Property: Use getattr/setattr
                            if getattr(equipment_ind, "equipmentId", None) != eq_id_str:
                        ...
                        if prop_equipmentModel:
                            ...
                            if model:
                                # Functional Property: Use getattr/setattr
                                if getattr(equipment_ind, "equipmentModel", None) != model:
                        ...
                        if cls_EquipmentClass and prop_memberOfClass and prop_equipmentClassId and prop_defaultSequencePosition:
                            ...
                            if eq_class_name:
                                ...
                                if eq_class_ind:
                                    ...
                                    if getattr(eq_class_ind, "equipmentClassId", None) != eq_class_name:
                ...
                if mat_id and cls_Material:
                    ...
                    if mat_ind:
                        ...
                        if prop_materialId: # Functional
                            if getattr(mat_ind, "materialId", None) != mat_id:
                        ...
                        if prop_materialUOM: # Functional
                            ...
                            if material_uom and getattr(mat_ind, "materialUOM", None) != material_uom:
                        ...
                        if prop_standardUOM: # Functional
                            ...
                            if uom_st and getattr(mat_ind, "standardUOM", None) != uom_st:
                        ...
                        if prop_targetProductUOM: # Functional
                            ...
                            if tp_uom and getattr(mat_ind, "targetProductUOM", None) != tp_uom:
                ...
                if req_id and cls_ProductionRequest:
                    ...
                    if req_ind:
                        ...
                        if prop_requestId: # Functional
                            if getattr(req_ind, "requestId", None) != req_id:
                        ...
                        if prop_requestRateUOM: # Functional
                            ...
                            if rate_uom and getattr(req_ind, "requestRateUOM", None) != rate_uom:
                ...
                if shift_name and cls_Shift:
                    ...
                    if shift_ind:
                        ...
                        if prop_shiftStartTime and getattr(shift_ind, "shiftStartTime", None) is None:
                            ...
                            if st: setattr(shift_ind, "shiftStartTime", st)
                        ...
                        if prop_shiftEndTime and getattr(shift_ind, "shiftEndTime", None) is None:
                            ...
                            if et: setattr(shift_ind, "shiftEndTime", et)
                        ...
                        if prop_shiftDurationMinutes and getattr(shift_ind, "shiftDurationMinutes", None) is None:
                            ...
                            if dur is not None: setattr(shift_ind, "shiftDurationMinutes", dur)
                ...
                # Use a name derived from the interval base for clear association
                event_record_base = f"Event_{interval_base}"
                ...
                if prop_rampUpFlag: # Functional
                    ...
                    if getattr(event_ind, "rampUpFlag", None) != ramp_flag:
                ...
                if prop_occursDuring and time_interval_ind:
                    if getattr(event_ind, "occursDuring", None) != time_interval_ind:
                ...
                if prop_duringShift and shift_ind:
                    if getattr(event_ind, "duringShift", None) != shift_ind:
                ...
                if prop_eventHasState and state_ind:
                    if getattr(event_ind, "eventHasState", None) != state_ind:
                ...
                if prop_eventHasReason and reason_ind:
                    if getattr(event_ind, "eventHasReason", None) != reason_ind:
